//! Types and extraction schema for codex ingest.

use serde::{Deserialize, Serialize};

pub(crate) const MIN_CODEX_VERSION: &str = "0.120.0";

/// OpenAI structured output schema with `additionalProperties: false` at all nested levels.
pub(crate) const EXTRACTION_SCHEMA_CODEX: &str = r#"{
  "type": "object",
  "properties": {
    "name": { "type": "string" },
...
pub(crate) struct PhaseEvent<'a> {
    ...
    pub(crate) codex_path: Option<&'a str>,
    #[serde(skip_serializing_if = "Option::is_none")]
