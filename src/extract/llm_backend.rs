...
//!
//! Heuristic extraction backend: derives candidate entities and
//! relationships from the body text without calling any provider.
...
pub struct LlmExtractorConfig {
    /// Backend label carried into `ExtractionOutput.backend`.
    pub backend: String,
